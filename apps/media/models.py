...
class Photo(models.Model):
	...
	photo = models.ImageField(upload_to='theplumbaker/images/photos', width_field='photo_width', height_field='photo_height')
	caption = models.TextField(help_text='A brief description of this photo. Use <a href="http://daringfireball.net/projects/markdown/syntax">Markdown syntax</a>.')
	...
	credit_link = models.URLField(blank=True, help_text="The link to the photographer's Web site.")
